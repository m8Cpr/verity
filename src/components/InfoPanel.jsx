...
const InfoPanel = () => {
    ...
    return (
        <Popover className={'text-foreground ' + (isDark ? "dark" : "light")} placement="left-end" backdrop="opaque">
            <PopoverTrigger>
                <Button isIconOnly color="primary" radius="full" variant="solid" className="float-right sticky bottom-8 right-8 lg:bottom-4">i</Button>
            </PopoverTrigger>
            <PopoverContent className="w-64 lg:w-96">
                <div className="flex flex-col px-4 py-4 lg-py-6">
                    ...
                    <span className="text-small">
                        <strong>Example:</strong> A pyramid is made of 2 triangles, and a cone is made of 1 triangle and 1 circle. Selecting these two shapes results in 3 triangles and 1 circle, which will never be correct.
                    </span>
                </div>
            </PopoverContent>
        </Popover>
